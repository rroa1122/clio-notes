...
const Record: React.FC = () => {
    ...
    return (
        <div className="flex flex-col items-center w-full pt-6 lg:pt-8 px-4 pb-12 animate-in fade-in duration-500">
            ...
            <Card className="max-w-6xl w-full bg-surface border border-border/60 shadow-soft rounded-card overflow-hidden relative group">
                <CardHeader className="px-10 pt-10 pb-2 space-y-1">
                    <div className="flex items-center gap-3">
                        <div className="size-9 rounded-xl bg-slate-900 flex items-center justify-center shadow-md shadow-slate-200">
                            <Sparkles size={18} className="text-white" />
                        </div>
                        <CardTitle className="text-2xl font-semibold tracking-tight text-slate-900">New encounter</CardTitle>
                    </div>
                    <CardDescription className="text-sm text-slate-500 font-medium ml-12 tracking-tight opacity-100 mt-1">
                ...
                <CardContent className="px-10 pt-8 pb-10 space-y-12">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                                <div className="space-y-2.5">
                                    ...
                                    <div className="relative group/input">
                                        <Input
                                            ...
                                            className="h-11 pl-4 pr-10 rounded-input bg-white border-slate-200 hover:border-slate-300 focus-visible:ring-2 focus-visible:ring-primary/20 focus-visible:border-primary/40 focus-visible:ring-offset-0 text-sm font-medium text-slate-900 transition-all duration-200 placeholder:text-slate-400 shadow-none"
                                        />
                                ...
                                <div className="space-y-2.5">
                                    ...
                                    <Input
                                        ...
                                        className="h-11 rounded-input bg-white border-slate-200 hover:border-slate-300 px-4 font-semibold font-mono text-sm [color-scheme:light] text-slate-900 focus-visible:ring-2 focus-visible:ring-primary/20 focus-visible:border-primary/40 focus-visible:ring-offset-0 transition-all duration-200 shadow-none"
                                    />
                                </div>
                                ...
                                <div className="space-y-2.5 sm:col-span-2">
                                    ...
                                    <div className="relative" ref={dropdownRef}>
                                        <Button
                                            ...
                                            className={cn(
                                                "w-full h-11 rounded-input bg-white border-slate-200 justify-between px-4 font-semibold text-sm text-slate-900 transition-all duration-200 hover:bg-slate-50/50 hover:border-slate-300 shadow-none",
                    ...
                    <div className="flex flex-col items-center pt-4">
                        ...
                        <div className="w-full max-w-2xl bg-slate-50/50 border border-slate-200/60 rounded-[28px] p-8 flex flex-col items-center gap-6 shadow-sm group/action">
                            <div className="flex flex-col items-center gap-1.5 text-center">
                                <Badge variant="outline" className="bg-white border-slate-200 text-slate-500 font-bold px-2.5 py-0.5 rounded-full mb-1">
                                    Primary Task
                                </Badge>
                            ...
                            <div className="flex flex-col items-center gap-8 w-full">
                                <div className="flex flex-col items-center gap-4">
                                    ...
                                    <div
                                        className={cn(
                                            "relative size-20 rounded-[24px] border-2 flex items-center justify-center transition-all duration-500",
                                            status === 'recording'
                                                ? "bg-red-50 border-red-200 text-red-500 shadow-[0_0_30px_rgba(239,68,68,0.1)]"
                                                : "bg-white border-slate-200 text-slate-400 group-hover/action:border-slate-300"
                                        )}
                                    >
                                    ...
                                    {status === 'idle' && !audioBlob && (
                                        <>
                                            <Button
                                                ...
                                                className="h-11 flex-1 max-w-[240px] rounded-button font-bold text-sm bg-slate-900 text-white shadow-md shadow-slate-200 hover:translate-y-[-1px] hover:bg-slate-800 active:translate-y-[0px] transition-all duration-200"
                                            >
                                                Initiate capture
                                            </Button>
                                            ...
                                            <Button
                                                ...
                                                className="h-11 px-8 rounded-button font-bold text-sm text-slate-600 border-slate-200 hover:bg-slate-50 hover:text-slate-900 hover:border-slate-300 transition-all duration-200 gap-2.5"
                                            >
                                    ...
                                    {status === 'recording' && (
                                        <div className="flex items-center gap-4">
                                            ...
                                            <Button
                                                ...
                                                className="h-11 px-12 bg-slate-900 rounded-button font-bold text-sm text-white shadow-md shadow-slate-200 hover:translate-y-[-1px] transition-all"
                                            >
                                                Seal acquisition
                                            </Button>
                                        </div>
                                    ...
                                    {audioBlob && status !== 'recording' && status !== 'done' && (
                                        <div className="flex gap-4 w-full max-w-md">
                                            <Button
                                                ...
                                                className="h-11 px-6 rounded-button font-bold text-sm text-slate-500 border-slate-200 hover:text-destructive hover:border-destructive/20 hover:bg-destructive/5 transition-all"
                                            >
                                                Discard
                                            </Button>
                                            <Button
                                                ...
                                                disabled={status === 'uploading' || status === 'processing'}
                                                className="flex-1 h-11 rounded-button font-bold text-sm shadow-md shadow-slate-200 gap-2.5 bg-slate-900 text-white hover:translate-y-[-1px] active:translate-y-[0px] hover:bg-slate-800 transition-all"
                                            >
