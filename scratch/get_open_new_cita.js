...
async function main() {
    ...
    const openNewCitaDef = await page.evaluate(() => {
        return typeof window.openNewCita !== 'undefined' ? window.openNewCita.toString() : 'undefined';
    });

    console.log('OPEN NEW CITA FUNCTION:\n', openNewCitaDef);
    await context.close();
}
