...
async function run() {
    ...
    console.log('Launching persistent Chrome on DISPLAY :99...');
    ...
    console.log('Navigated to Amexzone appointment page.');
    ...
    console.log('Browser is now open and streaming on VNC.');
    // Keep process alive indefinitely so user can view and interact
    await new Promise(() => {});
}
