...
import { ChevronLeft, ChevronRight, Plus, Search, User, SlidersHorizontal } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col overflow-hidden h-[100%] w-full">
      <div className="flex flex-col flex-1 bg-surface rounded-2xl md:rounded-[2rem] shadow-[0_8px_40px_-12px_rgba(0,0,0,0.06)] border border-border/60 overflow-hidden relative">
        ...
        {/* Header */}
        <div className="flex flex-none flex-wrap sm:flex-nowrap items-center justify-between gap-2 sm:gap-3 md:gap-4 px-3 py-2.5 md:px-5 md:py-3 xl:px-8 xl:py-4 bg-surface z-20 shrink-0 border-b md:border-b-0 border-border/40">
             ...
             <div className="flex flex-col gap-1">
                 ...
                 <div className="flex items-center gap-1 sm:gap-1.5 md:gap-2 border border-slate-200/50 dark:border-slate-800/50 rounded-full p-0.5 h-8 sm:h-9 md:h-10 bg-slate-50/30 dark:bg-slate-950/10 shadow-sm">
                     <button 
                         onClick={goToToday}
                         className="rounded-full h-6 sm:h-7 md:h-8 px-2 sm:px-2.5 md:px-3.5 font-black text-[9px] tracking-wider bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800 text-slate-700 dark:text-slate-350 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white hover:shadow-sm transition-all cursor-pointer"
                     >
                     ...
                     <div className="flex items-center gap-0.5 bg-white/60 dark:bg-slate-900/60 p-0.5 rounded-full border border-slate-200/50 dark:border-slate-800/80 h-6 sm:h-7 md:h-8 ml-auto">
                         <button 
                             onClick={previousWeek} 
                             className="h-5 w-5 sm:h-6 sm:w-6 md:h-7 md:w-7 rounded-full text-slate-500 hover:text-slate-900 dark:hover:text-white hover:bg-white dark:hover:bg-slate-800 transition-all bg-transparent border-0 cursor-pointer flex items-center justify-center"
                         >
            ...
            {/* Nav Right - Search */}
             <div className="flex flex-col gap-1 flex-1 max-w-full sm:max-w-[240px] lg:max-w-[340px] xl:max-w-[420px]" ref={searchContainerRef}>
                 ...
                 <div className="flex items-center border border-slate-200/80 dark:border-slate-800/80 rounded-full px-2.5 sm:px-3 md:px-4 h-8 sm:h-9 md:h-10 bg-slate-50/50 dark:bg-slate-950/20 shadow-sm relative group hover:border-slate-350 dark:hover:border-slate-700 focus-within:border-primary/40 focus-within:ring-2 focus-within:ring-primary/10 transition-all">
                      <div className="text-slate-400 mr-2 sm:mr-3 pointer-events-none flex-shrink-0">
        ...
        {/* Agenda Grid 7-Day View (Desktop, Tablet & Mobile Horizontal Scroll) */}
        <div className="flex flex-1 overflow-x-auto custom-scrollbar relative px-2 sm:px-3 lg:px-4 pb-2 sm:pb-2.5 xl:px-6 xl:pb-4 bg-surface border-t border-border/60 min-h-0">
